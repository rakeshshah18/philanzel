...
const ServicePage = () => {
    ...
    return (
        <div style={{ background: isDarkMode ? '#181818' : isDarkMode ? '#000' : 'linear-gradient(135deg, #b6b2efff 0%, #dfccf0ff 100%)', minHeight: '100vh' }}>
            <h1 style={{
                background: isDarkMode ? '#222' : '#9588ccff',
                ...
                <div>
                    ...
                    <div className="row justify-content-center">
                        {service.sections.map((section, idx) => (
                            <div key={section._id || idx} className="col-12 col-md-6 d-flex justify-content-center" style={{ paddingLeft: '0.25rem', paddingRight: '0.25rem' }}>
                                <div className="card shadow-sm mb-4 flex-fill" style={{
                                    maxWidth: 800,
                                    minWidth: 380,
                                    borderRadius: 16,
                                    border: 'none',
                                    ...
                                    <div className="card-body" style={{ padding: '1.25rem 1rem' }}>
                                        ...
                                        <h3 className="card-title" style={{
                                            marginBottom: 12,
                                            background: isDarkMode ? '#222' : '#cdc9e0ff',
                                            color: isDarkMode ? '#fff' : '#212529',
                                            padding: '0.5rem 1rem',
                                            borderRadius: '8px',
                                            fontWeight: 600,
